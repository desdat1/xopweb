    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="px-6 py-16 bg-gray-900/30">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative rounded-xl overflow-hidden shadow-2xl shadow-red-500/20 border border-gray-700 mb-8">
            <video
              className="w-full h-auto"
              controls
              preload="metadata"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-red-400 mb-3">Customizable Scoring Weights</h3>
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-red-400 mb-3">AI Assignment & Skills Evaluation</h3>
              <p className="text-gray-300 text-sm mb-3">
