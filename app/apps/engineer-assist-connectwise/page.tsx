      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white via-red-100 to-white bg-clip-text text-transparent">
              Engineer Assist
            </h1>
            <p className="text-2xl text-red-400 font-semibold mb-4">
              for ConnectWise Manage PSA
            </p>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              AI-powered assistance that helps your engineers resolve tickets faster with intelligent search,
              ticket insights, and client context - all within ConnectWise Manage.
            </p>
