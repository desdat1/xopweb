        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 animate-slideIn">
              AI-powered efficiency tools for ConnectWise engineers
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-12">
              Engineer App v4 is a game-changing overlay for ConnectWise Manage that brings AI-powered assistance 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
                ...
                <p className="text-gray-400">Works directly within ConnectWise Manage interface</p>
              </div>
            </div>
