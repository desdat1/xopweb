...
import { Video, CheckCircle, Mail, User, ArrowLeft, ExternalLink, Play, DollarSign } from 'lucide-react'
import Link from 'next/link'

export default function RevenueWebinarPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/webinar', {
        ...
        body: JSON.stringify({
          ...formData,
          webinar: 'MSPs & GenAI - Build a Revenue Generating Practice'
        }),
      })
        ...
        <section className="px-6 py-20">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-6 mb-8">
              ...
              <a
                href="https://youtu.be/Jn0hEY9qMOI"
                target="_blank"
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-6 mb-8">
              ...
              <ul className="text-left space-y-3 text-gray-300">
                ...
                <li className="flex items-center gap-3">
                  ...
                  Implement the revenue generation strategies
                </li>
                <li className="flex items-center gap-3">
                  <User className="w-5 h-5 text-green-400 flex-shrink-0" />
                  Schedule a consultation to build your AI practice
                </li>
              </ul>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              <div className="bg-gradient-to-br from-green-900/20 to-emerald-900/20 border border-green-500/30 rounded-xl p-8 mb-8">
                ...
                <h1 className="text-3xl font-bold mb-4">MSPs & GenAI - Build a Revenue Generating Practice</h1>
                <p className="text-lg text-gray-300 mb-6">
                  Learn how to transform your MSP into a revenue-generating AI powerhouse. Discover proven strategies 
                  for building and scaling an AI practice that delivers real ROI for both you and your clients.
                </p>
                
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold text-green-400">What You'll Learn:</h3>
                  <ul className="space-y-2 text-gray-300">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0" />
                      How to build a profitable AI service offering
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0" />
                      Revenue models that work for AI services
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0" />
                      Client acquisition strategies for AI services
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0" />
                    ...
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0" />
                      Case studies from successful MSP AI practices
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0" />
                      Building partnerships for AI service delivery
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-colors"
                  >
                    <option value="">What's your revenue goal from AI?</option>
                    <option value="$10K-$25K additional monthly">$10K-$25K additional monthly</option>
                    <option value="$25K-$50K additional monthly">$25K-$50K additional monthly</option>
                    <option value="$50K-$100K additional monthly">$50K-$100K additional monthly</option>
                    <option value="$100K+ additional monthly">$100K+ additional monthly</option>
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed px-6 py-4 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>
