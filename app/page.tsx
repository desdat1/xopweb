...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      {splashVisible && (
        <section className="bg-gradient-to-r from-yellow-600/30 via-yellow-500/20 to-yellow-600/30 border-b border-yellow-500/30 relative">
          {/* Close Button */}
          <button
            ...
            <div className="max-w-5xl mx-auto">
              <div className="flex flex-col lg:flex-row items-center gap-8">
                ...
                <div className="flex-shrink-0">
                  ...
                  <div className="text-sm text-gray-400 text-center lg:text-left">September 2 - 5, Honolulu, Hawaii</div>
                </div>
                
                {/* Event Content */}
                <div className="flex-1 text-center lg:text-left">
                  <h2 className="text-2xl lg:text-3xl font-bold mb-4 text-white">
                    Building the Future of MSP Operations in Honolulu
                  </h2>
                  <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                    Matt will be in Honolulu September 2 - 5 and is available to meet with MSPs to discuss building 
