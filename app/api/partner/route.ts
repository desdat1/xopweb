...
export async function POST(request: NextRequest) {
  try {
    ...
    const { firstName, lastName, email, companyName, staffSize, message } = body

    // Validate required fields
    if (!firstName || !lastName || !email || !companyName || !staffSize) {
    ...
    const { data, error } = await resend.emails.send({
      ...
      to: ['matt@xop.ai'],
      subject: `Rezolve Partner Lead: ${firstName} ${lastName} from ${companyName}`,
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
          ...
          <title>New Rezolve Partner Lead</title>
          <style>
            ...
            .header p { color: #e9d5ff; font-size: 14px; margin: 8px 0 0 0; }
        ...
        <body>
          <div class="email-container">
            <div class="header">
              <h1>New Rezolve Partner Lead</h1>
              <p>Submitted via xop.ai/partner/rezolve</p>
            </div>

            <div class="content">
              <p>A new lead has come in from the Rezolve.ai partner landing page.</p>
              ...
              <div class="contact-details">
                ...
                <ul>
                  ...
                  <li><strong>Staff Size:</strong> ${staffSize}</li>
              ...
              <div class="message-section">
                <h3>What&apos;s Important to Them</h3>
                <p style="color: #d1d5db; line-height: 1.6; white-space: pre-wrap;">${message}</p>
              </div>
              ` : ''}

              <p style="margin-top: 30px; color: #10b981;">
                <strong>Next Steps:</strong> Follow up to schedule the 30-minute introductory call.
              </p>
            </div>

            <div class="footer">
              <p>Rezolve.ai Partner Lead &mdash; xop.ai</p>
            </div>
          </div>
        </body>
        </html>
    ...
    console.log('Partner lead email sent successfully:', {
      firstName,
      lastName,
      companyName,
      staffSize,
