      ...
      features: [
        {
          ...
          title: 'Customizable Scoring Weights',
          description: 'Define escalation parameters by adjusting weights for disruption, priority, age, cadence, technical issues, end user sentiment, chronic/repeat calls, empathy, and clarity.'
        },
        {
          icon: <Brain className="w-6 h-6 text-red-400" />,
          title: 'AI-Generated Alerts',
          description: 'AI analyzes technical solution strength, communication cadence, and progress patterns to identify at-risk tickets with "Why Escalate" rationale.'
        },
        {
          icon: <Target className="w-6 h-6 text-red-400" />,
          title: 'AI Assignment Suggestions',
          description: 'When escalating, AI suggests engineers with confidence scores and runs technical skills evaluation before assignment.'
        },
        {
          icon: <Clock className="w-6 h-6 text-red-400" />,
          title: 'Training & Client Reviews',
          description: 'Use scoring weights for engineer and manager training exercises and preparing for client reviews.'
        }
      ],
      benefits: [
        ...
        'Train engineers using weighted scoring scenarios'
      ],
      process: [
        'Filter by Company, Engineer, and minimum score (4-9)',
        'AI scores tickets based on customizable risk weights',
        'Hover over tickets to see "Why Escalate" rationale and summary',
        'Click AI Assignment to see engineer suggestions with confidence scores',
        'Run Technical Skills evaluation before reassigning escalated tickets'
      ]
    },
    'client-health': {
